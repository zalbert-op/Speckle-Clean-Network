...
def main():
    ...
    opt['input_folder'] = 'G:/newcv/CGNet/CascadedGaze/datasets/SIDD/Data2'
    opt['save_folder'] = 'G:/newcv/CGNet/CascadedGaze/datasets/SIDD/val/input_crops'
    opt['crop_size'] = 512
    opt['step'] = 384
    opt['thresh_size'] = 0
    opt['keywords'] = '_NOISY'
    ...
    opt['save_folder'] = 'G:/newcv/CGNet/CascadedGaze/datasets/SIDD/val/gt_crops'
    opt['keywords'] = '_GT'
    extract_subimages(opt)
