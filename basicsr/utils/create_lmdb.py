...
def create_lmdb_for_SIDD():
    folder_path = 'G:/newcv/CGNet/CascadedGaze/datasets/SIDD/val/input_crops'
    lmdb_path = 'G:/newcv/CGNet/CascadedGaze/datasets/SIDD/val/input_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = 'G:/newcv/CGNet/CascadedGaze/datasets/SIDD/val/gt_crops'
    lmdb_path = 'G:/newcv/CGNet/CascadedGaze/datasets/SIDD/val/gt_crops.lmdb'
